...
%token _SYMB_111    //   identity
%token _SYMB_112    //   if
%token _SYMB_113    //   import
%token _SYMB_114    //   in
%token _SYMB_115    //   inline
%token _SYMB_116    //   inverse
%token _SYMB_117    //   lshr_2b
%token _SYMB_118    //   lshr_4b
%token _SYMB_119    //   lshr_8b
%token _SYMB_120    //   lshr_b
%token _SYMB_121    //   lshr_b4
%token _SYMB_122    //   lshr_b8
%token _SYMB_123    //   mul_2b
%token _SYMB_124    //   mul_2f
%token _SYMB_125    //   mul_4b
%token _SYMB_126    //   mul_4f
%token _SYMB_127    //   mul_4f4
%token _SYMB_128    //   mul_8b
%token _SYMB_129    //   mul_8f
%token _SYMB_130    //   mul_b
%token _SYMB_131    //   mul_b4
%token _SYMB_132    //   mul_b8
%token _SYMB_133    //   namespace
%token _SYMB_134    //   neg_2b
%token _SYMB_135    //   neg_4b
%token _SYMB_136    //   neg_8b
%token _SYMB_137    //   neg_b
%token _SYMB_138    //   neg_b4
%token _SYMB_139    //   neg_b8
%token _SYMB_140    //   not_2b
%token _SYMB_141    //   not_4b
%token _SYMB_142    //   not_8b
%token _SYMB_143    //   not_b
%token _SYMB_144    //   or_2b
%token _SYMB_145    //   or_4b
%token _SYMB_146    //   or_8b
%token _SYMB_147    //   or_b
%token _SYMB_148    //   pi
%token _SYMB_149    //   pure
%token _SYMB_150    //   rem_2f
%token _SYMB_151    //   rem_4f
%token _SYMB_152    //   rem_4f4
%token _SYMB_153    //   rem_8f
%token _SYMB_154    //   repeat
%token _SYMB_155    //   return
%token _SYMB_156    //   sdiv_2b
%token _SYMB_157    //   sdiv_4b
%token _SYMB_158    //   sdiv_8b
%token _SYMB_159    //   sdiv_b
%token _SYMB_160    //   sdiv_b4
%token _SYMB_161    //   sdiv_b8
%token _SYMB_162    //   selfinverse
%token _SYMB_163    //   shl_2b
%token _SYMB_164    //   shl_4b
%token _SYMB_165    //   shl_8b
%token _SYMB_166    //   shl_b
%token _SYMB_167    //   shl_b4
%token _SYMB_168    //   shl_b8
%token _SYMB_169    //   srem_2b
%token _SYMB_170    //   srem_4b
%token _SYMB_171    //   srem_8b
%token _SYMB_172    //   srem_b
%token _SYMB_173    //   srem_b4
%token _SYMB_174    //   srem_b8
%token _SYMB_175    //   sub_2b
%token _SYMB_176    //   sub_2f
%token _SYMB_177    //   sub_4b
%token _SYMB_178    //   sub_4f
%token _SYMB_179    //   sub_4f4
%token _SYMB_180    //   sub_8b
%token _SYMB_181    //   sub_8f
%token _SYMB_182    //   sub_b
%token _SYMB_183    //   sub_b4
%token _SYMB_184    //   sub_b8
%token _SYMB_185    //   type
%token _SYMB_186    //   udiv_2b
%token _SYMB_187    //   udiv_4b
%token _SYMB_188    //   udiv_8b
%token _SYMB_189    //   udiv_b
%token _SYMB_190    //   udiv_b4
%token _SYMB_191    //   udiv_b8
%token _SYMB_192    //   until
%token _SYMB_193    //   urem_2b
%token _SYMB_194    //   urem_4b
%token _SYMB_195    //   urem_8b
%token _SYMB_196    //   urem_b
%token _SYMB_197    //   urem_b4
%token _SYMB_198    //   urem_b8
%token _SYMB_199    //   where
%token _SYMB_200    //   while
%token _SYMB_201    //   xor_2b
...
;
TLDeclaration : _SYMB_113 _IDENT_ _SYMB_0 { $$ = new DImport($2);  } 
  | _SYMB_107 _IDENT_ _SYMB_0 { $$ = new DExpose($2);  }
;
Declaration : _SYMB_133 _IDENT_ _SYMB_1 ListDeclaration _SYMB_2 { $$ = new DNamespace($2, reverseListDeclaration($4));  } 
  ...
  | ListTypeSpecifier _SYMB_185 Type _IDENT_ _SYMB_0 { $$ = new DTypeDecl(reverseListTypeSpecifier($1), $3, $4);  }
...
OperatorName : _SYMB_205 { $$ = new ONOp($1);  } 
  ...
  | _SYMB_28 { $$ = new ONLxor();  }
;
OperatorTrait : _SYMB_111 Type OperatorName Expression { $$ = new OTIdentity($2, $3, $4);  } 
;
FunctionSpecifier : _SYMB_106 { $$ = new FSEntryPoint();  } 
  | _SYMB_149 { $$ = new FSPure();  }
  | _SYMB_115 { $$ = new FSInline();  }
  | _SYMB_69 { $$ = new FSAssociative();  }
  | _SYMB_97 { $$ = new FSCommutative();  }
  | _SYMB_62 { $$ = new FSAntiCommutative();  }
  | _SYMB_116 OperatorName { $$ = new FSInverse($2);  }
  | _SYMB_162 { $$ = new FSSelfInverse();  }
;
...
;
GenericParam : _SYMB_185 _IDENT_ { $$ = new TSGParam($2);  } 
;
...
;
Statement : _SYMB_155 Expression _SYMB_0 { $$ = new SReturn($2);  } 
  | Expression _SYMB_0 { $$ = new SExpression($1);  }
  | _SYMB_1 ListStatement _SYMB_2 { $$ = new SScope(reverseListStatement($2));  }
  | _SYMB_112 _SYMB_3 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SIf($3, reverseListStatement($6));  }
  | _SYMB_112 _SYMB_3 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 _SYMB_105 _SYMB_1 ListStatement _SYMB_2 { $$ = new SIfElse($3, reverseListStatement($6), reverseListStatement($10));  }
  | _SYMB_154 _SYMB_3 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SLoop($3, reverseListStatement($6));  }
  | _SYMB_200 _SYMB_3 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SWhile($3, reverseListStatement($6));  }
  | _SYMB_192 _SYMB_3 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SUntil($3, reverseListStatement($6));  }
  ...
  | _SYMB_109 _SYMB_104 _SYMB_3 _IDENT_ _SYMB_114 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SForEach($4, $6, reverseListStatement($9));  }
  | _SYMB_109 _SYMB_57 _SYMB_3 _IDENT_ _SYMB_114 Expression _SYMB_4 _SYMB_1 ListStatement _SYMB_2 { $$ = new SForAll($4, $6, reverseListStatement($9));  }
...
Expression10 : _SYMB_1 ListExpression _SYMB_2 { $$ = new EArray($2);  } 
  ...
  | _SYMB_1 Expression _SYMB_199 ListExpression _SYMB_2 { $$ = new EAComp($2, $4);  }
  | _SYMB_29 Expression _SYMB_199 ListExpression _SYMB_30 { $$ = new ELComp($2, $4);  }
  | Expression _SYMB_29 Expression _SYMB_30 { $$ = new EIndex($1, $3);  }
  ...
  | _SYMB_182 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSubB($3, $5);  }
  | _SYMB_130 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMulB($3, $5);  }
  | _SYMB_189 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdivB($3, $5);  }
  | _SYMB_159 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdivB($3, $5);  }
  | _SYMB_196 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUremB($3, $5);  }
  | _SYMB_172 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSremB($3, $5);  }
  | _SYMB_61 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAndB($3, $5);  }
  | _SYMB_147 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinOrB($3, $5);  }
  | _SYMB_204 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinXorB($3, $5);  }
  | _SYMB_166 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShlB($3, $5);  }
  | _SYMB_120 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshrB($3, $5);  }
  | _SYMB_66 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshrB($3, $5);  }
  | _SYMB_143 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNotB($3);  }
  | _SYMB_137 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNegB($3);  }
  ...
  | _SYMB_175 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub2B($3, $5);  }
  | _SYMB_123 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul2B($3, $5);  }
  | _SYMB_186 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv2B($3, $5);  }
  | _SYMB_156 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdiv2B($3, $5);  }
  | _SYMB_193 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem2B($3, $5);  }
  | _SYMB_169 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSrem2B($3, $5);  }
  | _SYMB_58 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAnd2B($3, $5);  }
  | _SYMB_144 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinOr2B($3, $5);  }
  | _SYMB_201 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinXor2B($3, $5);  }
  | _SYMB_163 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShl2B($3, $5);  }
  | _SYMB_117 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshr2B($3, $5);  }
  | _SYMB_63 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshr2B($3, $5);  }
  | _SYMB_140 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNot2B($3);  }
  | _SYMB_134 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNeg2B($3);  }
  ...
  | _SYMB_177 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub4B($3, $5);  }
  | _SYMB_125 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul4B($3, $5);  }
  | _SYMB_187 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv4B($3, $5);  }
  | _SYMB_157 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdiv4B($3, $5);  }
  | _SYMB_194 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem4B($3, $5);  }
  | _SYMB_170 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSrem4B($3, $5);  }
  | _SYMB_59 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAnd4B($3, $5);  }
  | _SYMB_145 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinOr4B($3, $5);  }
  | _SYMB_202 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinXor4B($3, $5);  }
  | _SYMB_164 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShl4B($3, $5);  }
  | _SYMB_118 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshr4B($3, $5);  }
  | _SYMB_64 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshr4B($3, $5);  }
  | _SYMB_141 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNot4B($3);  }
  | _SYMB_135 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNeg4B($3);  }
  ...
  | _SYMB_180 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub8B($3, $5);  }
  | _SYMB_128 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul8B($3, $5);  }
  | _SYMB_188 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv8B($3, $5);  }
  | _SYMB_158 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdiv8B($3, $5);  }
  | _SYMB_195 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem8B($3, $5);  }
  | _SYMB_171 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSrem8B($3, $5);  }
  | _SYMB_60 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAnd8B($3, $5);  }
  | _SYMB_146 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinOr8B($3, $5);  }
  | _SYMB_203 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinXor8B($3, $5);  }
  | _SYMB_165 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShl8B($3, $5);  }
  | _SYMB_119 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshr8B($3, $5);  }
  | _SYMB_65 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshr8B($3, $5);  }
  | _SYMB_142 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNot8B($3);  }
  | _SYMB_136 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNeg8B($3);  }
  ...
  | _SYMB_183 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSubB4V($3, $5);  }
  | _SYMB_131 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMulB4V($3, $5);  }
  | _SYMB_190 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdivB4V($3, $5);  }
  | _SYMB_160 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdivB4V($3, $5);  }
  | _SYMB_197 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUremB4V($3, $5);  }
  | _SYMB_173 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSremB4V($3, $5);  }
  | _SYMB_167 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShlB4V($3, $5);  }
  | _SYMB_121 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshrB4V($3, $5);  }
  | _SYMB_67 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshrB4V($3, $5);  }
  | _SYMB_138 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNegB4V($3);  }
  | _SYMB_54 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAddB8V($3, $5);  }
  | _SYMB_184 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSubB8V($3, $5);  }
  | _SYMB_132 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMulB8V($3, $5);  }
  | _SYMB_191 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdivB8V($3, $5);  }
  | _SYMB_161 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSdivB8V($3, $5);  }
  | _SYMB_198 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUremB8V($3, $5);  }
  | _SYMB_174 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSremB8V($3, $5);  }
  | _SYMB_168 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinShlB8V($3, $5);  }
  | _SYMB_122 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinLshrB8V($3, $5);  }
  | _SYMB_68 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAshrB8V($3, $5);  }
  | _SYMB_139 _SYMB_3 Expression _SYMB_4 { $$ = new EIntrinNegB8V($3);  }
  | _SYMB_46 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAdd2F($3, $5);  }
  | _SYMB_176 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub2F($3, $5);  }
  | _SYMB_124 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul2F($3, $5);  }
  | _SYMB_100 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv2F($3, $5);  }
  | _SYMB_150 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem2F($3, $5);  }
  | _SYMB_48 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAdd4F($3, $5);  }
  | _SYMB_178 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub4F($3, $5);  }
  | _SYMB_126 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul4F($3, $5);  }
  | _SYMB_101 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv4F($3, $5);  }
  | _SYMB_151 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem4F($3, $5);  }
  | _SYMB_51 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAdd8F($3, $5);  }
  | _SYMB_181 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub8F($3, $5);  }
  | _SYMB_129 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul8F($3, $5);  }
  | _SYMB_103 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv8F($3, $5);  }
  | _SYMB_153 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem8F($3, $5);  }
  | _SYMB_49 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinAdd4F4V($3, $5);  }
  | _SYMB_179 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinSub4F4V($3, $5);  }
  | _SYMB_127 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinMul4F4V($3, $5);  }
  | _SYMB_102 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUdiv4F4V($3, $5);  }
  | _SYMB_152 _SYMB_3 Expression _SYMB_32 Expression _SYMB_4 { $$ = new EIntrinUrem4F4V($3, $5);  }
  | Expression11 { $$ = $1;  }
;
