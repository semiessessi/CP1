...
{
       0,     0,     3,     5,    11,    18,    20,    22,    24,    26,
      28,    32,    35,    37,    41,    42,    45,    46,    50,    51,
      54,    55,    58,    59,    61
};
...
{
      19,     0,    -1,    26,    -1,    23,     4,     5,    26,     6,
      -1,    28,    17,    30,     5,    27,     6,    -1,    13,    -1,
      14,    -1,    12,    -1,    11,    -1,    17,    -1,    23,     7,
       8,    -1,    15,    16,    -1,    17,    -1,    29,    23,    17,
      -1,    -1,    26,    20,    -1,    -1,    27,    24,     9,    -1,
      -1,    28,    21,    -1,    -1,    29,    22,    -1,    -1,    25,
      -1,    25,    10,    30,    -1
};
...
{
       0,   312,   312,   314,   315,   317,   318,   320,   322,   323,
...
static const char *const yytname[] =
{
  ...
  "_SYMB_8", "_SYMB_9", "_SYMB_10", "_SYMB_11", "_INTEGER_", "_IDENT_",
  "$accept", "Code", "Declaration", "FunctionSpecifier",
  "VariableSpecifier", "Type", "Statement", "ParameterDeclaration",
  "ListDeclaration", "ListStatement", "ListFunctionSpecifier",
  "ListVariableSpecifier", "ListParameterDeclaration", 0
};
#endif
...
{
      14,     0,    18,     1,     8,     9,    15,     0,     0,     0,
       0,     5,     6,    20,    19,    14,    10,    12,    23,     0,
       0,    18,    20,     7,    21,     0,    16,     3,    24,    13,
       0,     4,     0,     0,    11,    17
};
...
{
      -8,    15,     0,    -8,    -8,    -8,    -8,     2,     5,    16,
      12,    -8,    -8,    -4,    -8,    -8,    -8,    -8,    13,    -7,
      19,    -3,    -4,    -8,    -8,    -5,    -8,    -8,    -8,    -8,
       1,    -8,     9,    17,    -8,    -8
};
...
{
      -2,   -22,    10,    27,     4,    23,     9,    31,     4,    10,
       5,     4,    29,    17,     5,     3,    32,     5,    11,    12,
      16,    15,    13,    22,    26,    34,    35,    25,    28,    21
};

static const yytype_uint8 yycheck[] =
{
       0,     5,     7,     6,    11,    12,     4,     6,    11,     7,
      17,    11,    17,    17,    17,     0,    15,    17,    13,    14,
       8,     5,    17,    10,     5,    16,     9,    19,    22,    15
};
...
{
       0,    19,    26,     0,    11,    17,    20,    23,    28,     4,
       7,    13,    14,    17,    21,     5,     8,    17,    25,    29,
      30,    26,    10,    12,    22,    23,     5,     6,    30,    17,
      27,     6,    15,    24,    16,     9
};
...
/* Line 1455 of yacc.c  */
#line 312 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.code_) = new Main(reverseListDeclaration((yyvsp[(1) - (1)].listdeclaration_))); YY_RESULT_Code_= (yyval.code_); ;}
    break;

  case 3:

/* Line 1455 of yacc.c  */
#line 314 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.declaration_) = new DObjectScope((yyvsp[(1) - (5)].type_), reverseListDeclaration((yyvsp[(4) - (5)].listdeclaration_)));  ;}
    break;

  case 4:

/* Line 1455 of yacc.c  */
#line 315 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.declaration_) = new DFunction(reverseListFunctionSpecifier((yyvsp[(1) - (6)].listfunctionspecifier_)), (yyvsp[(2) - (6)].string_), (yyvsp[(3) - (6)].listparameterdeclaration_), reverseListStatement((yyvsp[(5) - (6)].liststatement_)));  ;}
    break;

  case 5:

/* Line 1455 of yacc.c  */
#line 317 "C:\\Code\\cp\\cp1\\cp1\\.y"
...
/* Line 1455 of yacc.c  */
#line 324 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.type_) = new TArray((yyvsp[(1) - (3)].type_));  ;}
    break;

  case 11:

/* Line 1455 of yacc.c  */
#line 326 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.statement_) = new SReturn((yyvsp[(2) - (2)].int_));  ;}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 328 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.parameterdeclaration_) = new PDAutoParameter((yyvsp[(1) - (1)].string_));  ;}
    break;

  case 13:

/* Line 1455 of yacc.c  */
#line 329 "C:\\Code\\cp\\cp1\\cp1\\.y"
...
/* Line 1455 of yacc.c  */
#line 335 "C:\\Code\\cp\\cp1\\cp1\\.y"
    { (yyval.liststatement_) = new ListStatement((yyvsp[(2) - (3)].statement_), (yyvsp[(1) - (3)].liststatement_));  ;}
    break;

  case 18:

/* Line 1455 of yacc.c  */
#line 337 "C:\\Code\\cp\\cp1\\cp1\\.y"
